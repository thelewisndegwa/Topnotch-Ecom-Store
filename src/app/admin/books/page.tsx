 ...
 * Admin Books Page
 * 
 * Frontend-only books management page.
 * No API calls, authentication, or backend dependencies.
 * Uses static mock data from /data/admin/books.ts
 */

import { adminBooks } from '@/data/admin/books';
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {adminBooks.map((book) => (
                <tr key={book.slug} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-600">{book.subject}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
